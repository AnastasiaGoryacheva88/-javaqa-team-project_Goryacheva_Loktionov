...
public class PlayerTest {
    ...
    @Test
    public void ShouldSumHoursWhenGameInstalled() {
        GameStore store = new GameStore();
        Game game = store.publishGame("Нетология Баллт Онлайн", "Аркады");
    ...
    public void ReturnMustUsableGameByGenre() {
        GameStore store = new GameStore();
        Game game1 = store.publishGame("Нетология Баллт Онлайн", "Аркады");
